========================================================================
    KONSOLENANWENDUNG: rational_cpp-Projektübersicht
========================================================================

Diese rational_cpp-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre rational_cpp-Anwendung besteht.


rational_cpp.vcxproj
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen rational_cpp.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
